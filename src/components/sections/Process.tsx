...
const steps = [
  ...
  },
  {
    ...
    description:
      "Our uniformed, background-checked team arrives at the scheduled time — fully equipped for window, carpet, upholstery, or bin cleaning, whichever you've booked.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "We bring commercial-grade kit and the right technique for every surface — pure water for glass, hot extraction for carpets and sofas, and high-pressure jetting for bins.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    step: "04",
    title: "Enjoy a Fresher Home",
    description:
      "Step back and see the difference. Whether it's sparkling windows, soft fresh carpets, or fresh-smelling bins — your home feels brand new again.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl lg:text-5xl">
            Four Steps to a Cleaner Home
          </h2>
          <p className="mt-4 text-lg leading-relaxed text-slate-600">
            Booking us is effortless. Here's how a typical job from quote to finish unfolds.
          </p>
        </AnimatedSection>
